...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle d-flex justify-content-start align-items-center">
            ...
            <a type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="<?= $texts['i_package_employer'] ?>">
    ...
    <script src="../js/application_employers/packages/get_package_show.js"></script>
    <script src="../js/application_employers/packages/apply_package.js"></script>
</body>
