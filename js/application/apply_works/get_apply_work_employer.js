getSessionToken()
    .then(mySession => {
        if (mySession.token && mySession.role === 'member') {
            ...
            fetch(apiUrl + 'application/apply_works/get_apply_work_employer.php?employer_code=' + employer_code, {
                method: 'GET',
                headers: {
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="text-center">
                        ...
                        <a type="button" class="btn btn-primary" href="educations_employer.php?user_code=${data.user_code}&fullname=${data.firstname}%20${data.lastname}">${texts.education}</a>
                        <a type="button" class="btn btn-primary" href="experiences_employer.php?user_code=${data.user_code}&fullname=${data.firstname}%20${data.lastname}">${texts.experience}</a>
                    </div>
