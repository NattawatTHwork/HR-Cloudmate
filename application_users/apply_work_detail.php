...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle d-flex justify-content-start align-items-center">
            <h1 class="me-4"><?= $texts['job_detail'] ?></h1>
            <a type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="<?= $texts['i_apply_works_detail_applicant'] ?>">
    ...
    <script src="../js/application_users/apply_works/create_job_view.js"></script>
