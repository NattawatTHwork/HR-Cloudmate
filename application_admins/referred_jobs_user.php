...
<body>
    ...
    <script src="../js/application_admins/referred_jobs_user/function.js"></script>
    <script src="../js/application_admins/referred_jobs_user/get_job_category_all.js"></script>
    <script src="../js/application_admins/referred_jobs_user/get_work_location_all.js"></script>
    <script src="../js/application_admins/referred_jobs_user/get_employment_type_all.js"></script>
    <script src="../js/application_admins/referred_jobs_user/get_referred_job_user.js"></script>
    <script src="../js/application_admins/referred_jobs_user/update_referred_job.js"></script>
    <script src="../js/application_admins/referred_jobs_user/delete_referred_job.js"></script>
</body>
