...
<body>
    ...
    <script src="../js/application_admins/jobs/function.js"></script>
    <script src="../js/application_admins/jobs/get_job_category_all.js"></script>
    <script src="../js/application_admins/jobs/get_work_location_all.js"></script>
    <script src="../js/application_admins/jobs/get_employment_type_all.js"></script>
    <script src="../js/application_admins/jobs/get_other_type_all.js"></script>
    <script src="../js/application_admins/jobs/package_amount.js"></script>
    <script src="../js/application_admins/jobs/get_job_employer.js"></script>
    <script src="../js/application_admins/jobs/update_job.js"></script>
    <script src="../js/application_admins/jobs/delete_job.js"></script>
</body>
