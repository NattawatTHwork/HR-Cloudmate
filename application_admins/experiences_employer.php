...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle d-flex justify-content-start align-items-center">
            <h1 class="me-4"><?= $texts['experience'] ?> <?= $_GET['fullname'] ?></h1>
            <a type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="<?= $texts['i_experiences_employer'] ?>">
    ...
    <script src="../js/application_admins/experiences_employer/get_experience_employer.js"></script>
</body>
