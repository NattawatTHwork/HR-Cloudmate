...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle d-flex justify-content-start align-items-center">
            <h1 class="me-4"><?= $texts['education'] ?> <?= $_GET['fullname'] ?></h1>
            <a type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="<?= $texts['i_educations_employer'] ?>">
    ...
    <script src="../js/application_admins/educations_employer/get_education_employer.js"></script>
</body>
