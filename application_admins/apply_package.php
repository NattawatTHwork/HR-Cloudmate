...
<body>
    ...
    <script src="../js/application_admins/apply_packages/get_apply_package_employer.js"></script>
    <script src="../js/application_admins/apply_packages/change_status.js"></script>
</body>
