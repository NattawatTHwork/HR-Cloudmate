...
<body>
    ...
    <script src="../js/application_admins/educations_user/get_education_user.js"></script>
    <script src="../js/application_admins/educations_user/update_education.js"></script>
    <script src="../js/application_admins/educations_user/delete_education.js"></script>
</body>
