...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle d-flex justify-content-start align-items-center">
            <h1 class="me-4"><?= $texts['manage_resume'] ?></h1>
        ...
        <section class="section">
            <div class="row align-items-top" id="cardContainer">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title"><?= $texts['upload_resume'] ?></h5>
                            <form id="uploadForm">
                                <div class="mb-3">
                                    <label for="formFile" class="form-label text-danger"><?= $texts['choose_PDF'] ?></label>
                                    <input class="form-control" type="file" id="formFile" accept="application/pdf">
                                </div>
                                <div class="d-flex justify-content-center">
                                    <button type="button" class="btn btn-primary" onclick="uploadPDF()"><?= $texts['upload'] ?></button>
                                </div>
                            </form>
    ...
    <script src="../js/application_admins/resumes/upload_pdf.js"></script>
    <script src="../js/application_admins/resumes/display_pdf.js"></script>
