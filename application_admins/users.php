...
<body>
    ...
    <script src="../js/application_admins/users/get_user_all.js"></script>
    <script src="../js/application_admins/users/get_user.js"></script>
    <script src="../js/application_admins/users/update_user.js"></script>
    <script src="../js/application_admins/users/change_password.js"></script>
    <script src="../js/application_admins/users/delete_user.js"></script>
</body>
