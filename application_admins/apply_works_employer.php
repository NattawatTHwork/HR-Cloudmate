...
<head>
    ...
    <title>รับสมัครงาน | CM WORKFORCE</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle d-flex justify-content-start align-items-center">
            <h1 class="me-4"><?= $texts['job_application'] ?></h1>
            <a type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="<?= $texts['i_apply_works_employer'] ?>">
    ...
    <script src="../js/application_admins/apply_works/get_apply_work_employer.js"></script>
</body>
