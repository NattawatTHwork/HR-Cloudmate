...
<head>
    ...
    <title>รอดำเนินการ | CM WORKFORCE</title>
...
<body>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="datatables" class="table table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <th><?= $texts['position'] ?></th>
                                        <th><?= $texts['job_category'] ?></th>
                                        <th><?= $texts['company'] ?>/<?= $texts['entrepreneur'] ?></th>
                                        <th><?= $texts['work_location'] ?></th>
                                        <th><?= $texts['salary'] ?></th>
                                        <th><?= $texts['option'] ?></th>
                                    </tr>
                                </thead>
    ...
    <script src="../js/application_admins/jobs_approval/get_job_approval_on_hold_all.js"></script>
</body>
