...
<body>
    ...
    <script src="../js/application_part_time_users/apply_works/get_salary.js"></script>
    <script src="../js/application_part_time_users/apply_works/get_job_category_all.js"></script>
    <script src="../js/application_part_time_users/apply_works/get_work_location_all.js"></script>
    <script src="../js/application_part_time_users/apply_works/get_employment_type_all.js"></script>
    <script src="../js/application_part_time_users/apply_works/get_other_type_all.js"></script>
    <script src="../js/application_part_time_users/apply_works/get_job.js"></script>
</body>
