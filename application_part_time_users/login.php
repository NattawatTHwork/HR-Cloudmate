...
<head>
    ...
    <title>เข้าสู่ระบบผู้สมัครงาน Part Time | CM WORKFORCE</title>
...
<body>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4"><?= $texts['applicant_login'] ?> Part Time</h5>
                                    </div>
    ...
    <script src="../js/application_part_time_users/part_time_users/login_part_time_user.js"></script>
