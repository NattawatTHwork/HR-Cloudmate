...
<head>
    ...
    <title>ลงทะเบียนผู้สมัครงาน Part Time | CM WORKFORCE</title>
...
<body>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4"><?= $texts['applicant_register'] ?> Part Time</h5>
                                    </div>
                                    ...
                                    <form class="row g-3" method="POST" action="">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="password" name="part_time_user_password" class="form-control" id="yourPassword" required>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="password" name="part_time_user_repeat_password" class="form-control" id="yourRepeatPassword" required>
    ...
    <script src="../js/application_part_time_users/part_time_users/create_part_time_user.js"></script>
