<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a href="<?= $path ?>/application_part_time_users/index.php" class="logo d-flex align-items-center">
        ...
        <ul class="d-flex align-items-center">
            ...
            <li class="nav-item dropdown pe-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="<?= $path ?>/application_part_time_users/profile.php">
                ...
                <li>
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="<?= $path ?>/application_part_time_users/change_password_user.php">
